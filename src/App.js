          ...
          <>
            ...
            <div style={S.card}>
              ...
              <p style={{ margin: "10px 0 0", fontSize: "12px", color: "#a09890" }}>
                "Total sleep" below is worked out from last night's bedtime (entered on {formatDate(prevDateStr(selectedDate))}) through to the wake time above — you don't need to do anything differently, it's calculated automatically.
              </p>
            </div>
